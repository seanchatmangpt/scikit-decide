...
from autofde_lab.builders.domain.scheduling.graph_toolbox import Graph
from autofde_lab.builders.domain.scheduling.modes import MultiMode, SingleMode
from autofde_lab.builders.domain.scheduling.preallocations import (
    WithoutPreallocations,
    WithPreallocations,
)
from autofde_lab.builders.domain.scheduling.precedence import WithPrecedence
...
from autofde_lab.builders.domain.scheduling.resource_consumption import (
    ConstantResourceConsumption,
    VariableResourceConsumption,
)
from autofde_lab.builders.domain.scheduling.resource_costs import (
    WithModeCosts,
    WithoutModeCosts,
    WithoutResourceCosts,
    WithResourceCosts,
)
from autofde_lab.builders.domain.scheduling.resource_renewability import (
    MixedRenewable,
    RenewableOnly,
)
from autofde_lab.builders.domain.scheduling.resource_type import (
    WithoutResourceUnit,
    WithResourceTypes,
    WithResourceUnits,
)
...
from autofde_lab.builders.domain.scheduling.skills import (
    WithoutResourceSkills,
    WithResourceSkills,
)
from autofde_lab.builders.domain.scheduling.task import Task
...
from autofde_lab.builders.domain.scheduling.time_lag import WithoutTimeLag, WithTimeLag
...
class SchedulingDomain(
    ...
    # BUT i feel it's necessary to code it somewhere when i tested it in autofde_lab/hub/domain/rcpsp_pi2/rcpsp where
