...
from autofde_lab.hub.solver.ray_rllib.gnn.policy.sample_batch import (
    concat_samples_graph,
    concat_samples_graph2node,
)
from autofde_lab.hub.solver.ray_rllib.gnn.policy.sample_batch_original_code import (
...
def monkey_patch_concat_samples(graph2node: bool = False) -> None:
    ...
    - we only add to concat_samples.__globals__ the necessary names
      ...
      as it is autofde_lab.hub.solver.ray_rllib.gnn.policy.sample_batch namespace.
