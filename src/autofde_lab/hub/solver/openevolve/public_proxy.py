...
def get_domain_mixin_classes(obj: Any) -> tuple[type[Domain], ...]:
    ...
    :mod:`autofde_lab.builders.domain` module.
    ...
    # Identify all valid builder mixins in the autofde_lab.builders.domain namespace
    builder_mixin_set = {
        o
        for _, o in inspect.getmembers(autofde_lab.builders.domain)
