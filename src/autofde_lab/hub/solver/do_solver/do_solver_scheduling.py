...
from autofde_lab.builders.domain.scheduling.scheduling_domains import SchedulingDomain
...
from autofde_lab.solvers import DeterministicPolicies, Solver
...
def from_solution_to_policy(
    ...
    """Create a PolicyRCPSP object (a autofde_lab policy) from a scheduling solution
