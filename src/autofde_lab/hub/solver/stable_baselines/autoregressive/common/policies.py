...
from autofde_lab.hub.solver.stable_baselines.autoregressive.common.distributions import (
    MultiMaskableCategoricalDistribution,
)
from autofde_lab.hub.solver.stable_baselines.gnn.common.policies import (
    BaseGNNActorCriticPolicy,
)
from autofde_lab.hub.solver.utils.autoregressive.torch_utils import (
    batched_extract_action_component_mask,
    extract_action_component_mask,
)
from autofde_lab.hub.solver.utils.gnn.space_utils import (
    add_onehot_encoded_discrete_feature_to_graph_space,
)
from autofde_lab.hub.solver.utils.gnn.torch_layers import (
    Graph2NodeLayer,
    GraphFeaturesExtractor,
)
from autofde_lab.hub.solver.utils.gnn.torch_utils import unbatch_node_logits
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            action_gnn_class: GNN class for graph -> node nets.
                See `autofde_lab.hub.solver.utils.gnn.torch_layers.Graph2NodeLayer` for default values.
