...
from autofde_lab.builders.domain import MultiAgent, Sequential, SingleAgent
...
class MAHD(Solver, DeterministicPolicies, Utilities, FromAnyState):
    ...
    def _get_next_action(
        ...
        """
        return self._multiagent_solver._get_next_action(observation, domain=domain)
                ...
                if hasattr(self._singleagent_solvers[a], "get_policy"):
                    ...
                    if not s.is_solution_defined_for(observation[a]):
                        ...
                        self._singleagent_solutions[a][observation[a]] = (
                            ...
                            s.get_next_action(
                                observation[a], domain=self._get_singleagent_domain(a)
                            ),
                        )
