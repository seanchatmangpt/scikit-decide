...
from autofde_lab.hub.domain.flight_planning.aircraft_performance.performance.aero.service.speed_conversion_service import (
...
from autofde_lab.hub.domain.flight_planning.aircraft_performance.utils.poll_schumann_utils.aircraft_parameters import (
