...
from autofde_lab.builders.domain import FullyObservable, Renderable, UnrestrictedActions
from autofde_lab.core import Space, TransitionOutcome, Value
...
class RDDLDomain(D):
    ...
    def _get_action_space_(self) -> Space[D.T_event]:
        # Cast to autofde_lab's GymSpace
