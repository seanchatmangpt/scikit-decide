...
; generated for the real registered planner "IW" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("IW.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-iw") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-iw)
