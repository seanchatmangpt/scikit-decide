...
; generated for the real registered planner "MaxentIRL" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("MaxentIRL.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-maxentirl") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-maxentirl)
