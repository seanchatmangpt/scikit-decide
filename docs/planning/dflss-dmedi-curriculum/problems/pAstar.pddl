...
; generated for the real registered planner "pAstar" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("pAstar.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-pastar") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-pastar)
