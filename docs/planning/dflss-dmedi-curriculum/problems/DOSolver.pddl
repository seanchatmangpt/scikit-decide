...
; generated for the real registered planner "DOSolver" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("DOSolver.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-dosolver") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-dosolver)
