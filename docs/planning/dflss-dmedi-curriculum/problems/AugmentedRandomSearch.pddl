...
; generated for the real registered planner "AugmentedRandomSearch" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("AugmentedRandomSearch.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-augmentedrandomsearch") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-augmentedrandomsearch)
