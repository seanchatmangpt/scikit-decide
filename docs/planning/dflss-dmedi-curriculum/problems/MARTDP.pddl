...
; generated for the real registered planner "MARTDP" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("MARTDP.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-martdp") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-martdp)
