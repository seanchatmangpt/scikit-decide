...
; generated for the real registered planner "RFF" -- one of the 57 real
...
; :init and :goal never vary by planner. File identity ("RFF.pddl") and
; problem identity ("dflss-dmedi-curriculum-for-rff") are kept in lockstep
; by construction, per this session's task specification.
(define (problem dflss-dmedi-curriculum-for-rff)
