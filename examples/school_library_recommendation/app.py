...
st.caption("Synthetic POC data. LLM layer is represented by an offline schema parser for repeatable demo execution.")
student_id = st.selectbox("Student", sorted(circulation.student_id.unique()), index=3)
request = st.text_input("Librarian request", "Something funny, preferably a mystery, and not part of a long series.")
