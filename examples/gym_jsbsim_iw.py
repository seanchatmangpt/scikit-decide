...
from autofde_lab import Domain, EnvironmentOutcome, TransitionOutcome, Value
...
class GymIWDomain(D):
    ...
    def _get_initial_state_(self) -> D.T_state:
        ...
        return GymDomainStateProxy(
            state=normalize_and_round(state_proxy._state), context=state_proxy._context
        )
    ...
    def _state_step(
        ...
        return TransitionOutcome(
            state=GymDomainStateProxy(
                state=normalize_and_round(o.state._state), context=o.state._context
            ),
    ...
    def _get_next_state(
        ...
        return GymDomainStateProxy(
            state=normalize_and_round(o._state), context=o._context
        )
...
domain_factory = lambda: GymIWDomain(
